...
public class OlingoSampleApp {
	...
	public static void main(String[] params) throws Exception {
		...
		// app.perform("http://localhost:8080/Orders.svc");
		app.perform("http://services.odata.org/V4/Northwind/Northwind.svc");
	}
	
	
	public void perform(String serviceUrl) throws Exception {
		...
		print("\n----- Read Entities ------------------------------");
		ClientEntitySetIterator<ClientEntitySet, ClientEntity> iterator = readEntities(edm, serviceUrl, "Customers");
		...
		print("\n----- Read Entry ------------------------------");
		ClientEntity entry = readEntityWithKey(edm, serviceUrl, "Customers", "EASTC");
		print("Single Entry:\n" + prettyPrint(entry.getProperties(), 0));

//		//
//		print("\n----- Read Entity with $expand  ------------------------------");
//		entry = readEntityWithKeyExpand(edm, serviceUrl, "Customers", "EASTC", "Orders");
//		print("Single Entry with expanded Orders relation:\n" + prettyPrint(entry.getProperties(), 0));
//
//		//
//		print("\n----- Read Entities with $filter  ------------------------------");
//		iterator = readEntitiesWithFilter(edm, serviceUrl, "Customers", "Name eq 'Horse Powered Racing'");
//		while (iterator.hasNext()) {
//			ClientEntity ce = iterator.next();
//			print("Entry:\n" + prettyPrint(ce.getProperties(), 0));
//		}
		...
		// entry = createEntity(edm, serviceUrl, "Customers", ce);

		// print("\n----- Update Entry ------------------------------");
		// ce = loadEntity("/mymanufacturer2.json");
		// int sc = updateEntity(edm, serviceUrl, "Customers", 123, ce);
		// print("Updated successfully: " + sc);
		// entry = readEntityWithKey(edm, serviceUrl, "Customers", 123);
		// print("Updated Entry successfully: " + prettyPrint(entry.getProperties(),
		// 0));
		//
		// //
		// print("\n----- Delete Entry ------------------------------");
		// sc = deleteEntity(serviceUrl, "Customers", 123);
		// print("Deletion of Entry was successfully: " + sc);
		//
		// try {
		// print("\n----- Verify Delete Entry ------------------------------");
		// readEntityWithKey(edm, serviceUrl, "Customers", 123);
		// } catch(Exception e) {
		// print(e.getMessage());
		// }
	}
